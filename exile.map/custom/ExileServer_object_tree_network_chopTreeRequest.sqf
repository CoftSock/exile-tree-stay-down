...
try 
{
	...
	diag_log format ["%1, %2, %3, %4, %5, %6, %7", 	_treePosition select 0, _treePosition select 1, _treePosition select 2, _tree, _treeNetId, _treeHeight, _health];
	//16:49:36 "[5177.62,4583.29,0], 51564: t_ficus_medium_f.p3d, 1:-1828363924, 25.3137, 0.08"
	_data = 
	[
	_treePosition select 0, 
	_treePosition select 1, 
